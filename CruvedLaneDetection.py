...
def vid_pipeline(img):
    ...
    cv2.putText(img, 'Lane Curvature L: {:.0f} m'.format(curverad[0]),(570, 680), font, fontSize, fontColor, 2)
    cv2.putText(img, 'Lane Curvature R: {:.0f} m'.format(curverad[1]),(570, 700), font, fontSize, fontColor, 2)
...
img = cv2.imread('test_images/semibuena.jpg')
